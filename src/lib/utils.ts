/**
 * Утилиты для работы с DOM элементами и формами
 *
 * Этот модуль содержит вспомогательные функции для:
 * - Извлечения значений из различных типов полей формы
 * - Поиска контейнеров ошибок и лейблов
 * - Отображения и скрытия сообщений об ошибках
 * - Валидации структуры формы
 * - Создания сообщений об ошибках
 * - Проверки конфликтов правил валидации
 */
